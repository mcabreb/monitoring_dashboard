...
- [x] Create BluetoothDevice and DeviceType data models (AC: 2)
...
- [x] Implement Bluetooth device enumeration (AC: 1, 2)
...
- [x] Track device connections/disconnections (AC: 3)
