...
- [x] Create BatteryStatus and BatteryState data models (AC: 3)
...
- [x] Create DevicesCollector class (AC: 1, 2, 3)
...
- [x] Maintain battery history (AC: 4)
