...
- [x] Create LogEntry and LogSeverity data models (AC: 3, 4)
...
- [x] Create LogsCollector class (AC: 1, 2, 5)
...
- [x] Implement dmesg parsing (AC: 2, 3, 4)
...
- [x] Implement severity detection (AC: 4)
...
- [x] Handle permission issues (AC: 6)
