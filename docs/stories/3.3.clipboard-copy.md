...
- [x] Create clipboard utility wrapper (AC: 5, 6)
...
- [x] Implement copy_all method (AC: 2, 3)
  - [ ] Get all buffered entries (up to 100)
  - [ ] Format entries with full timestamps and messages
  - [ ] Call clipboard utility
  - [ ] Show feedback on success/failure
- [x] Format log entries for clipboard (AC: 3)
...
- [x] Handle clipboard errors (AC: 6)
