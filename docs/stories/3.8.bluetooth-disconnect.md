...
- [ ] Integrate disconnect detection with alerts (AC: 1, 2)
...
- [ ] Update alert engine for disconnect events (AC: 1, 4)
...
- [ ] Show "Disconnected" status briefly (AC: 3)
...
- [ ] Auto-clear on reconnection (AC: 5)
...
class DevicesPanel(BasePanel):
    ...
    def _render_disconnected_device(self, name: str) -> None:
        ...
        # e.g., "🎧 Sony WH-1000XM4  [Disconnected]"
```
...
│                                   │
│ 📶 Bluetooth Devices              │
│ 🎧 Sony WH-1000XM4    [Disconnected] │  <- Grayed, about to disappear
│ 🖱️ MX Master 3        [████████] 85% │
└───────────────────────────────────┘
```
