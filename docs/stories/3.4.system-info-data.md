...
- [ ] Implement kernel version retrieval (AC: 4)
  - [ ] Use platform.release() for kernel version
  - [ ] Handle exceptions gracefully
- [ ] Implement distribution info retrieval (AC: 5)
