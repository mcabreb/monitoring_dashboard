...
- [x] Create Alert and AlertType data models (AC: 4)
...
- [x] Create AlertEngine class (AC: 1, 2, 3)
...
- [x] Implement threshold checking (AC: 2, 3)
...
- [x] Implement acknowledgment API (AC: 6)
...
- [x] Implement alert lifecycle (AC: 5, 6)
