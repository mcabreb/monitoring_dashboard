...
- [ ] Create themed ProgressBar widget (AC: 1, 3)
...
- [ ] Update StoragePanel with disk display (AC: 1, 2, 4)
...
- [ ] Implement scrolling for many partitions (AC: 5)
...
- [ ] Handle empty/None data gracefully (AC: 1)
